...
def test_mockinterface_update_services_c1():
    ...
    assert_true(mockif.services.get(svc_name, None) is None)  # service not exposed yet
...
def test_mockinterface_update_services_c2():
    ...
    assert_true(mockif.services.get(svc_name, None) is None)  # service not exposed
...
def test_mockinterface_expose_update_services_fullname():
    ...
    svc = mockif.services.get(svc_name, None)
    assert_true(svc is None)  # service not exposed yet
