...
#TODO : make this less magic and more explicit ( to do it for tests but not for normal use )
    ...
    # This issue also means that we cannot define message/services types in pyros and expect them to be found by python only ( module will be loaded only once )
    ...
    # IMPORTANT : if this fails, the import of rosinterface HAS TO fail.
