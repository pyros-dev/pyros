...
# Design duplicated from pyros-setup
...
class _PyrosSetup(types.ModuleType):
    ...
    def activate(self):
        ...
        try:
            ...
            pyros_setup\
                ...
                .configure_from_mapping(**self.config.get_namespace('PYROS_SETUP_', lowercase=False))\
                .activate()
            import rospy
            from pyros.rosinterface.topic import TopicBack
            from pyros.rosinterface.service import ServiceBack
    ...
    @classmethod
    def delayed_import_new(cls, instance_path=None, instance_relative_config=True,
                              root_path=None):
